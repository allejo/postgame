...
class ImportReplayCommand extends Command
{
    ...
    /**
     * Whether or not we're in a "dry-run."
     *
     * @var bool
     */
    private $dry;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        {
            $output->writeln(sprintf('File or directory not found: %s', $replayFile));
        }
    ...
    private function importReplay(string $filename): void
    {
